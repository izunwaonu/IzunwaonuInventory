      ...
      <div className="mt-2">
        <div className="relative rounded-md ">
          ...
          <input
            ...
            disabled={disabled}
            className={cn(
              'block w-full read-only:bg-gray-100 rounded-md border-0 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-rose-600 sm:text-sm sm:leading-6 text-sm',
