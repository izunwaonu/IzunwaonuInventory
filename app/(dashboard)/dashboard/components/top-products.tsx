          ...
          <div className="space-y-2.5 p-3 sm:p-4 pt-0">
            {products.length === 0 ? (
              ...
              products.map((product, index) => (
                ...
                >
                  <div className="flex-shrink-0 w-6 h-6 bg-gradient-to-br from-blue-500 to-purple-600 rounded-md flex items-center justify-center text-white font-bold text-xs">
                    {index + 1}
                  </div>
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between mb-1">
