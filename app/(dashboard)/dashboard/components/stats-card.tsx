    ...
    <Card className="border-0 shadow-lg bg-white/80 backdrop-blur-sm hover:shadow-xl transition-all duration-300 group relative overflow-hidden">
      ...
      <CardContent className="p-3 sm:p-4 relative z-10">
        <div className="flex items-start justify-between">
          <div className="flex-1 min-w-0">
            ...
            {change !== undefined && (
              <div className="flex items-center gap-1">
                ...
                {description && (
                  <span className="text-xs text-gray-500 ml-1 truncate">{description}</span>
                )}
              </div>
            )}
          ...
          <div
            className={cn(
              'w-8 h-8 sm:w-10 sm:h-10 rounded-lg bg-gradient-to-br flex items-center justify-center group-hover:scale-110 transition-transform duration-300 flex-shrink-0 ml-2',
              gradient,
            )}
          >
