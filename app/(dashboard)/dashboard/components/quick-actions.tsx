        ...
        <div className="grid grid-cols-3 sm:grid-cols-6 gap-2 sm:gap-3">
          {actions.map((action) => (
            <Link key={action.title} href={action.href}>
              <Button
                variant="outline"
                className="h-auto p-2 sm:p-3 flex flex-col items-center gap-1.5 sm:gap-2 hover:shadow-md transition-all duration-300 group border-gray-200 hover:border-gray-300 w-full"
              >
                <div
                  className={`w-6 h-6 sm:w-8 sm:h-8 rounded-md bg-gradient-to-br ${action.gradient} flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}
                >
