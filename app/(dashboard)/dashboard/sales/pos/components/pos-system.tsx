  ...
  return (
    <div className="h-screen flex flex-col bg-gray-50">
      ...
      <div className="flex flex-1 min-h-0">
        ...
        <div className="flex-1 flex flex-col min-h-0">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <div className="flex gap-2 sm:gap-4 mt-1 text-xs sm:text-sm text-gray-600 flex-wrap">
                    <span className="truncate">
                      Today: ₦{stats.todaySales?.toFixed(2) || '0.00'}
                    </span>
                    <span className="whitespace-nowrap">Orders: {stats.todayOrders || 0}</span>
                  </div>
                </div>
          ...
          <div className="flex-1 overflow-auto p-3 sm:p-4">
            {loading ? (
              ...
              <div className="flex flex-col items-center justify-center h-full text-gray-500">
                <ShoppingCart className="h-12 w-12 sm:h-16 sm:w-16 mb-4 opacity-50" />
                  ...
                  >
                    <CardContent className="p-2 sm:p-3">
                      ...
                      <div className="space-y-1">
                        <h3 className="font-medium text-xs sm:text-sm leading-tight line-clamp-2 min-h-[2.5rem] sm:min-h-[2.8rem]">
                          {item.name}
                        </h3>
                        <p className="text-xs text-gray-500 truncate">{item.sku}</p>

                        <div className="flex items-center justify-between gap-1">
                          <span className="text-sm sm:text-base font-bold text-green-600 truncate">
                            ₦{item.sellingPrice.toFixed(2)}
                          </span>
                        ...
                        {item.category && (
                          <Badge
                            variant="outline"
                            className="text-xs px-1 py-0.5 w-full justify-center truncate"
                          >
                            {item.category.title}
                          </Badge>
                        )}
        ...
        {/* Desktop Cart Panel */}
        <div className="hidden lg:flex w-80 xl:w-96 bg-white border-l flex-col">
          <CartPanel
            cart={cart}
            selectedCustomer={selectedCustomer}
            subtotal={subtotal}
        ...
        {/* Mobile Cart Panel */}
        <div
          className={`fixed inset-y-0 right-0 w-full max-w-sm bg-white border-l flex-col z-50 transform transition-transform duration-300 lg:hidden ${
      ...
      <div className="p-3 sm:p-4 border-b flex-shrink-0">
        ...
        {selectedCustomer && (
          <div className="mt-2 p-2 bg-blue-50 rounded-lg">
            ...
            {selectedCustomer.email && (
              <p className="text-xs text-blue-700 mt-1 truncate">{selectedCustomer.email}</p>
            )}
          </div>
        )}
      </div>
